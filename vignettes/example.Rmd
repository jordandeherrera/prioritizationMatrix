---
title: "Example of Priority Matrix Package"
...
```{r heatmap, warning=FALSE, message=FALSE, eval = FALSE}
...
```{r pareto, warning=FALSE, message=FALSE, eval = FALSE}
...
```{r canvas, warning=FALSE, message=FALSE, eval = FALSE}
